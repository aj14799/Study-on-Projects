...
#folder = 'C:\\Users\\Aditya Jha(Adi)\\Videos\\Captures'

engine = pyttsx3.init()
voices = engine.getProperty('voices')

#b_music = ['audio 1', 'audio 2']
#pygame.mixer.init()
#pygame.mixer.music.load(folder + random.choice(b_music) + '.mp4')
...
class Widget:
    def __init__(self):
       root = Tk()
       root.title('Jarvis-20')
       root.config(background='Black')
       root.geometry('350x600')
       root.resizable(0, 0)
       #sroot.iconbitmap(r'F:\Pics and Vedios\Pics of different Ocassions\Outting  to Barbeque Company and CP\IMG_20180728_172548.jpg')
       #img = ImageTk.PhotoImage(file="F:\\Pics and Vedios\\Pics of different Ocassions\\Outting  to Barbeque Company and CP\\IMG_20180728_172548.jpg")
    ...
    def clicked(self):
        ...
        if 'open ccleaner' in query:
            ...
            self.compText.set('okay')
            speak('okay')
            subprocess.call(r'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Microsoft Office\Microsoft Office PowerPoint 2007.lnk')
